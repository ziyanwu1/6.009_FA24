...
class SchemeREPL(Cmd):
    ...
    def __init__(self, lab_module, use_frames=False, verbose=False, repl_frame=None):
    ...
    def completedefault(self, text, line, begidx, endidx):
        try:
            bound_vars = set(self.repl_frame)
        except:
            bound_vars = set()
