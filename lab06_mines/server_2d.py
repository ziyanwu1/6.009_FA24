...
def handle_render_2d(params):
    return lab.render_2d_locations(current_game_2d, params['all_visible'])
...
def handle_new_game_2d(params):
    ...
    current_game_2d = lab.new_game_2d(params['num_rows'], params['num_cols'], [tuple(i) for i in params['mines']])
